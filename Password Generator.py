...
def generator(x):
    ...
    for i in range(int(lengthinput)):
        ...
        pa = pa + password
    print("\nThis Password Generator is developed by Students of IT Department, YCCE Nagpur\nTHANK YOU")
...
def copy1(a):
    ...
    labelNum8 = tk.Label(root, text="Developed by Students of IT Department, YCCE Nagpur").grid(row=30, column=1)
